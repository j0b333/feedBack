...
(async () => {
    ...
    // The loader lives in ./js/plugin-loader.js and must not import app.js
    // (no-cycle), so hand it the one host function it needs.
    configurePluginLoader({ populateVizPicker: _populateVizPicker });
